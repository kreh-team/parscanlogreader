...
Note that we use `epochs_raw` instead of `epochs` on the parameters lists. This is because internally we calculate/parse another `epochs` variable. This will be improved in future versions.
